...
<body>
	<div class="container" id="container-aporte">
		...
		<div class="row">
			<div class="col-md-8 main-content" id="main-aporte">
				<div>
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<f:form id="form-aporte" method="post"
								action="grabar-aporte.html" commandName="aporte">
								<div class="form-horizontal">
									<div class="form-group">
										<label class="col-lg-2 control-label"> <t:message
												code="page.aportar.label.curso" />
										</label>
										<div class="col-lg-10">
											<f:hidden path="idUsuarioFk" />
											<f:select path="idCursoAperturadoFk.idCursoAperturado"
									...
									<div class="form-group">
										<label class="col-lg-2 control-label"> <t:message
												code="page.aportar.label.titulo" />
										</label>
										<div class="col-lg-10">
											<t:message code="page.aportar.placeholder.titulo"
									...
									<div class="form-group">
										<div class="col-lg-12">
											...
											<div class="btn-group" data-role="editor-toolbar"
												...
												<div class="btn-group">
													<button class="btn btn-default dropdown-toggle"
														type="button" data-toggle="dropdown" title="Font">
												...
												<div class="btn-group">
													<button class="btn btn-default dropdown-toggle"
														type="button" data-toggle="dropdown" title="Font Size">
														<i class="icon-text-height"></i>&nbsp;<b class="caret"></b>
													</button>
													<ul class="dropdown-menu">
														<li><a data-edit="fontSize 5"><font size="5">Grande</font></a>
														</li>
														<li><a data-edit="fontSize 3"><font size="3">Normal</font></a>
														</li>
														<li><a data-edit="fontSize 1"><font size="1">Pequeña</font></a>
														</li>
													</ul>
												</div>
												<div class="btn-group">
													<button type="button" class="btn btn-default"
														data-edit="bold" title="Negrita (Ctrl/Cmd+B)">
														<i class="fa fa-bold"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="italic" title="Cursiva (Ctrl/Cmd+I)">
														<i class="fa fa-italic"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="strikethrough" title="Tachado">
														<i class="fa fa-strikethrough"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="underline" title="Subrayado (Ctrl/Cmd+U)">
														<i class="fa fa-underline"></i>
													</button>
												</div>
												<div class="btn-group">
													<button type="button" class="btn btn-default"
														data-edit="insertunorderedlist" title="Viñeta">
														<i class="fa fa-list-ul"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="insertorderedlist" title="Lista">
														<i class="fa fa-list-ol"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="outdent" title="Disminuir Sangria (Shift+Tab)">
														<i class="fa fa-indent"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="indent" title="Aumetar Sangria (Tab)">
												...
												<div class="btn-group">
													<button type="button" class="btn btn-default"
														...
														title="Alinear a la Izquierda (Ctrl/Cmd+L)">
														<i class="fa fa-align-left"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="justifycenter" title="Centrar (Ctrl/Cmd+E)">
														<i class="fa fa-align-center"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="justifyright"
														title="Alinear a la Derecha (Ctrl/Cmd+R)">
														<i class="fa fa-align-right"></i>
													</button>
													<button type="button" class="btn btn-default"
														data-edit="justifyfull" title="Justificar (Ctrl/Cmd+J)">
														<i class="fa fa-align-justify"></i>
													</button>
												</div>
												<div class="btn-group">
													<button type="button" class="btn btn-default"
														title="Insertar Imagen (o solo arrastrala)"
														id="pictureBtn">
											...
											<div id="editor"></div>
											<f:hidden path="contenido" id="input-contenido-aporte" />
										</div>
									</div>
								</div>
							</f:form>
							<div class="form-horizontal">
								<div class="form-group">
									<label class="col-lg-2 control-label"> <t:message
											code="page.aportar.label.upload" />
									</label>
									<div class="col-lg-10">
										<form action="file-aporte.html" class="dropzone"
							...
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-lg-offset-2 col-lg-10">
										<div class="alert alert-warning" id="alert-form-aporte">
