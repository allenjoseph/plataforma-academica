var Timeline = function (container, date) {
    ...
    this.initialize = function () {
        this.isIE6 = (navigator.userAgent.match(/msie [6]/i));
    ...
    this.setupArrows = function () {
        ...
        var html = "";
        html += "<div class=\"timeline_lastyear\" title=\"Año Anterior\"></div>"
        html += "<div class=\"timeline_lastmonth\" title=\"Mes Anterior\"></div>"
        html += "<div class=\"timeline_date\">" + dateString + "</div>"
        html += "<div class=\"timeline_nextmonth\" title=\"Mes Siguiente\"></div>"
        html += "<div class=\"timeline_nextyear\" title=\"Año Siguiente\"></div>"
    ...
    this.setupPlaceHolders = function () {
        ...
        top.append("<ul></ul>");
        bottom.append("<ul></ul>");
        this.container.append([top[0], bottom[0],arrows[0]]);
        return {
            arrows: arrows,
